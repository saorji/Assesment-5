...
function handleSubmit(e) {
    ...
    axios.post('http://localhost:4005/cities', body)
        .then(() => {
...
function deleteCard(id) {
    axios.delete(`http://localhost:4005/cities/${id}`)
        .then(() => getCities())
...
function getCities() {
    ...
    axios.get('http://localhost:4005/cities/')
        .then(res => {
...
function getCountries() {
    axios.get('http://localhost:4005/countries')
        .then(res => {
